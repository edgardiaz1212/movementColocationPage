...
try {
     ...
     const brand = form.getTextField('MARCA');
      ...
      console.error('Error al cargar el PDF:', error);
            setIsLoading(false); // Marcar la carga como fallida
    }
  ...
  if (isLoading) {
    return <div>Cargando...</div>; // Mostrar indicador de carga mientras se carga el PDF
  }

  if (!filledPdf) {
    return <div>Error al cargar el PDF</div>; // Mostrar mensaje de error si la carga falla
  }
