...
function EditEquipment() {
  ...
  useEffect(() => {
    // Realiza una solicitud para obtener los datos del rack con el ID "theid"
    if (id) {
      actions.getEquipmentById(id)
        .then((equipmentByIdData) => {
          // Establece el estado inicial con los datos del rack
          setData({
            ...
            equip_rack_ubication:equipmentByIdData.equip_rack_ubication,
